...
防沉迷提醒 APP，是对各休闲 APP 用悬浮窗精细遮挡推荐内容，但搜索栏等其他菜单不做限制。即保留了“搜索引擎”的功能同时，规避了漫无目的的沉迷。 
想关闭悬浮窗就得做一道难度适中的算术题或推理题。

它是一款开源的、未上架的安卓 APP。

**适用范围**  
系统：安卓
APP：小红书、知乎、抖音、B 站……，预置支持 6 个APP，还可手动添加其他 APP。  
...
页面关键词、解禁时长和遮罩大小均可针对单 APP 个性化调整。
